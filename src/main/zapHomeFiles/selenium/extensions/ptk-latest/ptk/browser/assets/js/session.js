...
function initCookieForm(index) {
    ...
    let fields = {
        domain: { identifier: 'domain', rules: [{ type: 'notEmpty', prompt: 'Required value' }] },
        value: { identifier: 'value', rules: [{ type: 'notEmpty', prompt: 'Required value' }] },
        path: { identifier: 'path', rules: [{ type: 'notEmpty', prompt: 'Required value' }] },
    ...
    if (index == 'new') {
        ...
        fields['cookie_name'] = {
            ...
            rules: [
                { type: 'notEmpty', prompt: 'Required value' }
            ]
        }
    }
...
function getCookieForm(index) {
    return `<form class="ui small form segment cookie_form" id="cookie_form_${index}" index="${index}" style="margin-right: -10px;">
                ...
                <div class="inline fields">
                    ...
                    <div class="fourteen wide field ui calendar"><input type="text"  name="expDate" class="ui input" autocomplete="off"><input type="hidden"  name="expirationDate" /></div>
                </div>
