        ...
        $form.form({
            ...
            fields: {
                algorithm: {
                    ...
                    rules: [{ type: 'notEmpty', prompt: 'Algorithm is required' }]
                }
            }
        })
        ...
        $form.form({
            ...
            fields: {
                token: {
                    ...
                    rules: [{ type: 'notEmpty', prompt: 'Token is required' }]
                },
                public: {
                    identifier: 'jwk_injection_attack_dlg_public_key',
                    rules: [{ type: 'notEmpty', prompt: 'Public key is required' }]
                },
                private: {
                    identifier: 'jwk_injection_attack_dlg_private_key',
                    rules: [{ type: 'notEmpty', prompt: 'Private key is required' }]
                }
            }
        })
        $form.form('validate form')
    ...
    $form.form({
        ...
        fields: {
            algorithm: {
                ...
                rules: [{ type: 'notEmpty', prompt: 'Select required algorithm' }]
            }
        }
    })
        ...
        $pemform.form({
            ...
            fields: {
                ...
                pem_jwk_convertor_pem: {
                    ...
                    rules: [{ type: 'notEmpty', prompt: 'PEM certificate is required' }]
                }
            }
        })
        ...
        $jwkform.form({
            ...
            fields: {
                ...
                pem_jwk_convertor_jwk: {
                    ...
                    rules: [{ type: 'notEmpty', prompt: 'JWK certificate is required' }]
                }
            }
        })
